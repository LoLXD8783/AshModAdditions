...
{
    public class NebShooter : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Nebular Shooter");
            Tooltip.SetDefault("PlaceholderText");
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.knockBack = 1;
            item.value = 10000; // Please change
            item.rare = ItemRarityID.Red;
            item.UseSound = SoundID.Item12;
            item.autoReuse = true;
            item.shootSpeed = 16f;
            item.mana = 7;
            item.shoot = mod.ProjectileType("NebShooterProj");
        }
